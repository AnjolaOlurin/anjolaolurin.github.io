import {
    DefaultOptions as HashDefaultOptions,
    HashOptions,
    SCryptHash,
} from './scrypt-hash';
...
describe('SCryptHash', () => {
    ...
    it('hash should be verifiable', async () => {
        ...
        expect(
            await SCryptHash.verify(testPasswordCorrect, hash),
        ).toBeTruthy();
        expect(
            await SCryptHash.verify(testPasswordIncorrect, hash),
        ).toBeFalsy();
    });
    ...
    it('should accept options', async () => {
        ...
        const checkDefaultOpts = await SCryptHash.verify(
            testPasswordCorrect,
            hash,
        );
